...
VISOR SHORtS -s $out_dir/tumour -bed $bam_regions -g $genome -o $out_dir/tumour/bam
VISOR SHORtS -s $out_dir/normal -bed $bam_regions -g $genome -o $out_dir/normal/bam
